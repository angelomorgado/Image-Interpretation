...
from alphapose_utils.SPPE.src.utils.img import load_image, cropBox, im_to_torch
from alphapose_utils.opt import opt
from alphapose_utils.yolo.preprocess import prep_image, prep_frame, inp_to_image
from alphapose_utils.pPose_nms import pose_nms, write_json
from alphapose_utils.matching import candidate_reselect as matching
from alphapose_utils.SPPE.src.utils.eval import getPrediction, getMultiPeakPrediction
from alphapose_utils.yolo.util import write_results, dynamic_write_results
from alphapose_utils.yolo.darknet import Darknet
...
if opt.vis_fast:
    from alphapose_utils.fn import vis_frame_fast as vis_frame
else:
    from alphapose_utils.fn import vis_frame
...
class DetectionLoader:
    def __init__(self, dataloder, batchSize=1, queueSize=1024):
        # initialize the file video stream along with the boolean
        # used to indicate if the thread should be stopped or not
        self.det_model = Darknet("alphapose_utils/yolo/cfg/yolov3-spp.cfg")
        self.det_model.load_weights('alphapose_utils/models/yolo/yolov3-spp.weights')
